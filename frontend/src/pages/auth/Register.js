...
// Registration
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // 🚀 NAYA: Backend ko baaki details ke sath deviceId bhi bhej rahe hain
      const response = await api.post('/auth/register', {
        name, mobile, email, country, password, sponsorId,
        deviceId: visitorId 
      });

      // ✅ Setting name from response
      setRegisteredData({
      ...
      // Agar admin ne device block kiya hoga, toh yahan message show ho jayega

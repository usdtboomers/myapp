...
const AddUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const backendURL = process.env.REACT_APP_BACKEND_URL || 'http://143.198.205.94:5000/api/admin';

      const res = await axios.post(
        `${backendURL}/auth/register`, // Full URL: http://143.198.205.94:5000/api/admin/auth/register
        formData,
        {
          headers: {

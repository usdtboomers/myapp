...
//   const { user } = useAuth(); // logout hata diya
...
//               className="bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded text-white text-sm font-semibold"
//             >
//               📢 Join Telegram
//             </a>
